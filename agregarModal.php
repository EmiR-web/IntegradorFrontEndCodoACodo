<!-- Modal -->
<div class="modal fade" id="agregarModal" tabindex="-1" aria-labelledby="exampleModalLabel4" aria-hidden="true">
            ...
            <div class="modal-body p-4">
                <form action="oradores.php" method="POST">
                    ...
                    <div class="form-outline mb-4">
                        ...
                        <label class="form-label" for="textarea4">Temática</label>
                    </div>
